...
export const getTheme = (themeMode: ThemeMode) => {
  ...
  return createTheme(
    ...
    //   text: {
    //     primary: isDark ? '#FFFFFF' : '#000000', // основной текст
    //     secondary: isDark ? '#B0BEC5' : '#757575', // вспомогательный текст
    //   },
    //   action: {
    //     active: isDark ? '#FFFFFF' : '#000000', // иконки в кнопках
    //   },
    //   background: {
    //     default: isDark ? '#121212' : '#FFFFFF', // фон приложения
    //     paper: isDark ? '#1d1d1d' : '#ffffff', // фон элементов
    //   },
    // },
    // typography: {
    //   h1: {
